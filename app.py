...
def load_data(uploaded_file, cleaning_cost_default, import_mode):
    ...
    if ext in [".xls", ".xlsx"]:
        try:
            ...
            raise ValueError(
                "Excel non riconosciuto automaticamente. Verifica che contenga almeno colonne tipo nome ospite, arrivo, partenza e prezzo."
            )
        except Exception as e:
...
def render_profile_form(profilo, onboarding_mode=False):
    ...
    if campo_visibile("istruzioni_ingresso"):
        istruzioni_ingresso = st.text_area(
            campo_etichetta("istruzioni_ingresso"),
            value=str(profilo.get("istruzioni_ingresso", "") or ""),
            height=120,
        )

    if campo_visibile("note_finali"):
        note_finali = st.text_area(
            campo_etichetta("note_finali"),
            value=str(profilo.get("note_finali", "") or ""),
            height=120,
        )
    ...
    nuovi_dati = {
        ...
        "istruzioni_ingresso": istruzioni_ingresso,
