...
def load_booking_file(uploaded_file, cleaning_cost_default):
    ...
    status_col = find_col(
        ["stato pr", "stato p", "stato"],
        exclude_fragments=["pagamento", "payment", "commission", "commissione", "camera", "stanza", "metodo", "cancellazione"],
        prefer_exact=["stato pr", "stato prenotazione", "booking status", "reservation status"]
    )
